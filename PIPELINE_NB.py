...
'''INÍCIO DO BALANCEAMENTO COM SMOTE'''
...
df = pd.read_csv('tabela_new_leads_com_smote.csv')
...
(
    ...
    test_target # tabela de teste para coluna estagio
        ...
        df.drop(['estagio'], axis=1), # tabela sem a coluna estagio
        df['estagio'], # apenas a coluna estagio
#         test_size = .67,
#         random_state=42
)
...
print("\n",preds)
print("\n")
print("Precisão do Naive Bayes: ", accuracy_score(test_y, preds))